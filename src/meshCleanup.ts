...
export function cleanupMeshes(model: THREE.Group, allMeshes: MeshInfo[], modelScale: number): void {
  ...
  allMeshes.forEach((meshInfo, index) => {
    const isFlat = meshInfo.flatness < 0.15; // One dimension is < 15% of the largest
